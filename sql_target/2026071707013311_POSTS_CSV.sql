...
DECLARE
    ...
    target_tbl  TEXT := 'posts';                       -- Имя таблицы
    columns_lst TEXT := 'id,title,body,author_id';                     -- Колонки из CSV через запятую
    csv_path    TEXT := '/data/11.posts.csv';                        -- Путь к CSV-файлу
    -- =================================================
